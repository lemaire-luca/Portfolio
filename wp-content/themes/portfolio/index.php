    ...
    <main role="main">
        ...
        <section itemscope itemtype="https://schema.org/Person" id="profile" class="profile">
            ...
            <div class="profile__infos">
                ...
                <h2 role="heading" aria-level="2" class="profile__infos__small">je m'appelle <span itemprop="name"
                                                                                                   class="green">Luca</span>
                    !</h2>
                <p class="profile__infos__p">
                    Je suis un jeune web <span lang="en">developer</span> passionné, toujours aux études. Curieux et
                    motivé, je passe mon temps
